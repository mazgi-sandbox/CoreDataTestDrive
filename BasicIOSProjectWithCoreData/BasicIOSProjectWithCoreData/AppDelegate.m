...
//
//  Created by Matsuki Hidenori on 2/17/13.
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSString *managedObjectModelFileName = [[NSBundle mainBundle]objectForInfoDictionaryKey:kManagedObjectModelFileNameKey];
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:managedObjectModelFileName withExtension:nil];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSString *persistentStoreFileName = [[NSBundle mainBundle]objectForInfoDictionaryKey:kPersistentStoreFileNameKey];
